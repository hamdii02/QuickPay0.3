...
class UnsavedCordovaPlatforms extends base_1.Ailment {
    ...
    detected() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            let cordova;
            try {
                cordova = yield this.project.getIntegration('cordova');
            }
            catch (e) {
                return false;
            }
