...
class ConfigXml {
    ...
    reload() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const configFileContents = yield fs_1.fsReadFile(this.filePath, { encoding: 'utf8' });
...
function loadConfigXml({ project }) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        const cordova = yield project.getIntegration('cordova');
