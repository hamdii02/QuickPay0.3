...
class DoctorCommand extends command_1.Command {
    getRegistry() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { AilmentRegistry } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/doctor'));
    ...
    detectTreatableAilments() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            return ailments.filter((ailment) => cli_utils_1.isTreatableAilment(ailment));
        });
    }
}
