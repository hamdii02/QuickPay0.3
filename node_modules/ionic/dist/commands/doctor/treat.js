...
Optionally supply the ${chalk_1.default.green('id')} argument to attempt to fix a single issue. Use ${chalk_1.default.green('ionic doctor list')} to list all known issues.
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { formatAilmentMessage } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/doctor'));
            const [id] = inputs;
            if (id) {
                ...
                if (!cli_utils_1.isTreatableAilment(ailment)) {
    ...
    handleError(e) {
        if (e !== ERROR_AILMENT_SKIPPED && e !== ERROR_AILMENT_IGNORED) {
            if (cli_utils_1.isExitCodeException(e)) {
            ...
            if (choice === CHOICE_YES) {
                for (const i in treatmentSteps) {
                    ...
                    try {
                        ...
                        if (!cli_utils_1.isExitCodeException(e) || e.exitCode > 0) {
                            throw e;
                        }
                    }
                }
