...
This command uses Ionic servers, so we require you to be logged into your free Ionic account. Use ${chalk_1.default.green('ionic login')} to login.
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            const { RESOURCES, addResourcesToConfigXml, createImgDestinationDirectories, findMostSpecificSourceImage, getImageResources, getSourceImages, transformResourceImage, uploadSourceImage } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/integrations/cordova/resources'));
            if (!this.project) {
            ...
            const integration = yield this.project.getIntegration('cordova');
            const conf = yield loadConfigXml({ project: this.project });
            const platforms = yield getPlatforms(integration.root);
            ...
            try {
                srcImagesAvailable = yield getSourceImages(integration.root, buildPlatforms, resourceTypes);
            ...
            yield Promise.all(transformResults.map((result) => tslib_1.__awaiter(this, void 0, void 0, function* () {
                yield fs_1.copyFile(result.tmpDest, result.resource.dest);
