...
const path_1 = require("@ionic/cli-framework/utils/path");
...
The default directory for ${chalk_1.default.green('--key-path')} and ${chalk_1.default.green('--cert-path')} is ${chalk_1.default.green('.ionic/ssl/')}.
    ...
    ensureDirectory(p) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (!(yield fs_1.pathExists(p))) {
                yield fs_1.fsMkdirp(p, 0o700);
...
`.trim();
            const p = path_1.tmpfilepath('ionic-ssl');
            yield fs_1.fsWriteFile(p, cnf, { encoding: 'utf8' });
            return p;
        });
    }
}
