...
class HelpCommand extends command_1.Command {
    ...
    run(inputs, options) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            const { CommandSchemaHelpFormatter, CommandStringHelpFormatter, NamespaceSchemaHelpFormatter, NamespaceStringHelpFormatter } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/help'));
            const location = yield this.namespace.locate(inputs);
            if (cli_utils_1.isCommand(location.obj)) {
