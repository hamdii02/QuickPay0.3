    ...
    getMetadata() {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return {
                ...
                description: `
This command writes configuration values to the project's ${chalk_1.default.bold(cli_utils_1.PROJECT_FILE)} file. It can also operate on the global CLI configuration (${chalk_1.default.bold('~/.ionic/config.json')}) using the ${chalk_1.default.green('--global')} option.
