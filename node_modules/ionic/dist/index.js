...
function loadExecutor(ctx, pargv, env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        if (!_executor) {
            const deps = yield cli_utils_1.generateIonicEnvironment(ctx, pargv, env);
...
function run(pargv, env) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (err) {
            ...
            else if (cli_utils_1.isExitCodeException(err)) {
                if (err.message) {
                    if (err.exitCode > 0) {
...
function receive(msg) {
    return tslib_1.__awaiter(this, void 0, void 0, function* () {
        ...
        if (msg.type === 'telemetry') {
            const { sendCommand } = yield Promise.resolve().then(() => require('@ionic/cli-utils/lib/telemetry'));
            yield sendCommand({
                getInfo: env.getInfo,
                client: env.client,
                config: env.config,
